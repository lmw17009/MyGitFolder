...
function KeyboardHook(nCode: Integer; wParamv: WPARAM; lParamv: LPARAM): LRESULT; stdcall;
  ...
  var
    ...
    i: Integer;
  begin
  Form1.mmo1.Lines.Add('AcsiiToString...');
    Result := '';
    case VKCodeAcsii of
      13:
        begin
    ...
    Form1.mmo1.Lines.Add('AcsiiToString fun end...');
  end;
